# data-science-path guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `data_science_path/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `data_science_path` folder and use the modules inside your notebooks :
...
```python
from data_science_path.utils.paths import data_dir
data_dir()
```
